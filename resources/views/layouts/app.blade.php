...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo"><a href="/inicio">BlowShop</a></h1>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <div class="social-links mt-3">
                <a href="https://twitter.com/?lang=es" class="twitter"><i class="bx bxl-twitter"></i></a>
                <a href="https://www.facebook.com/" class="facebook"><i class="bx bxl-facebook"></i></a>
                <a href="https://www.instagram.com/" class="instagram"><i class="bx bxl-instagram"></i></a>
                <a href="https://mx.linkedin.com/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Compra</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Venta</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Publicidad</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Envios</a></li>
            </ul>
          </div>

          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Nuestro Boletin Informativo</h4>
            <p>Suscriete a nuestro Newsletter de forma gratuita</p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>BlowShop</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
